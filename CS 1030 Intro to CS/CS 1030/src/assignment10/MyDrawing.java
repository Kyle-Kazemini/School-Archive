/**
 This application makes a JFrame and populates it with exactly one panel
 * (made from this code). The program then draws a series of different shapes
 * filled in with different colors.
...
public class MyDrawing extends JPanel implements MouseListener
{
    ...
    public static void buildGUI()
    {
        ...
        MyDrawing ourPanel = new MyDrawing();
    ...
    public void paint (Graphics g)
    {
        ...
        g.setColor(new Color(120,120,255));			// Round edge rectangle filled with new color
        g.drawRoundRect(250, 250, 100, 100, 20, 15);
        g.fillRoundRect(250, 250, 100, 100, 20, 15);
        
        g.setColor(Color.white);					// Oval filled with white
        g.drawOval(50, 50, 50, 50);
        g.fillOval(50, 50, 50, 50);
        
        g.setColor(Color.CYAN);						// 3D Rectangle filled in with Cyan
        g.draw3DRect(150, 150, 50, 50, false);
        g.fill3DRect(150, 150, 50, 50, false);
        
        g.setColor(Color.GREEN);					// Arc filled in with Green
        g.drawArc(50, 250, 100, 100, 45, 90);
        g.fillArc(50, 250, 100, 100, 45, 90);
