 ...
 */
public class NightSky extends JPanel implements MouseListener
{
    private static final long serialVersionUID = 1L;  // Ignore :(  Useless junk that gets rid of a warning.  
	private static final Shape Shape = null;
    ...
    public static void buildGUI()
    {
        ...
        NightSky ourPanel = new NightSky();
    ...
    public void paint (Graphics g)
    {
        ...
        int moonX = (int)(Math.random() * width);
        int moonY = (int)(Math.random() * height);
        
        g.drawOval(moonX, moonY, 100, 100);
        g.setColor(Color.white);
        g.fillOval(moonX, moonY, 100, 100);
        
        g.drawOval(moonX+10, moonY+10, 100, 100);
        g.setColor(Color.black);
        g.fillOval(moonX+10,moonY+10,100,100);
	...
	private java.awt.Shape Shape(java.awt.Shape shape2) {
