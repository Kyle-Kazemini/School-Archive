 ...
 * 
 * Author: Kyle Kazemini  (change this to your name)
...
/**
 * This statement tells Java that we're creating a class. (Everything in Java is
 * part of a class.) Our class will be built as an extension of an existing
 * class (JPanel), and our class will listen for mouse events (for fun).
 */
public class Stoplight extends JPanel implements MouseListener {
	private static final long serialVersionUID = 1L; // Ignore :( Useless junk that gets rid of a warning.

	/**
	 * All Java applications begin execution in a main method. Here is where our
	 * program starts.
	 */
	...
	/**
	 * I didn't have time to show this in class. If you declare a variable -outside-
	 * of methods, they'll be part of an object, our object. They will last as long
	 * as the object does. Normally, variables inside of a method only last as long
	 * as that method is executing.
	 * 
	 * The following variables will be available to our panel. They'll last as long
	 * as the panel lasts. I chose what to declare here.
	 */
	 ...
	 * thread. Complex, but it needed to be done. You would not normally write code
	 * like the code in main. This method is where we build our GUI.
	 */
	public static void buildGUI() {
		...
		Stoplight ourPanel = new Stoplight();
	...
	/**
	 * Before a panel is drawn, the enclosing frame asks the panel how big it is.
	 * Since we are writing code for the panel, we'll write code that the -frame-
	 * will execute to determine our size. This happens automatically (the code
	 * below will be executed by someone else's code).
	 */
	@Override
	 ...
	 * activated in our panel. The exact form of these methods is required, but I
	 * get to choose what to put into each method.
	 * 
	 * (In most cases, I just left them empty. They are required, though, to listen
	 * for mouse events.)
	 */
	@Override
	...
	/**
	 * Notice that this method takes a parameter of type MouseEvent. When the mouse
	 * is pressed, this method gets called (from some other code), and when the
	 * method is called the calling code sends us a MouseEvent object. Our variable
	 * that receives the object is named 'e'.
	 */
	@Override
	 ...
	 * whenever Java detects that our window needs drawing. This may happen many
	 * times each second, or not once for a long while.
	 * 
	...
	public void paint(Graphics g) {
		...
		// Student code goes here (before the curly braces that closes the paint method
		// and class).
