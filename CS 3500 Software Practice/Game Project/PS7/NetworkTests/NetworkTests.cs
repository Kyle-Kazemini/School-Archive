...
namespace NetworkUtil
{
    ...
    public class NetworkTests
    {
        ...
        [DataRow(false)]
        [DataTestMethod]
        public void TestSendOnClosedSocket(bool clientSide)
        {
            SetupTestConnections(clientSide, out testListener, out testLocalSocketState, out testRemoteSocketState);
        ...
        public void TestInvalidHostName()
        {
            ...
            testListener = Networking.StartServer(saveServerState, 2112);
            Networking.ConnectToServer(saveClientState, "random host", 2112);
        ...
        public void TestInvalidIPAddress()
        {
            ...
            testListener = Networking.StartServer(saveServerState, 2112);
            Networking.ConnectToServer(saveClientState, "1.00..122.1", 2112);
